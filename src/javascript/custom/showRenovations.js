    ...
    fetch('/renovations.json')
        ...
        .then(data => {
            ...
            container.innerHTML = data.map(r => {
                let stateClass = '';
                let icon = '';
                if (r["Estado de póliza"] === "Pagado") {
                    stateClass = 'state__success';
                    icon = 'check';
                } else if (r["Estado de póliza"] === "Pendiente") {
                ...
                <div class="renovation-card-desktop">
                    <div class="renovation-card-desktop__policy">${r["No. de póliza"]}</div>
                    <div class="renovation-card-desktop__risk">${r["Nombre del riesgo"]}</div>
                    <div class="renovation-card-desktop__date-contrat">${r["Fecha de contrato"]}</div>
                    <div class="renovation-card-desktop__date-maturity">${r["Fecha de vencimiento"]}</div>
                    <div class="renovation-card-desktop__price">${r["Importe"]}</div>
                    <div class="state-cell">
                        <div class="renovation-card-desktop__state">
                            <div class="state ${stateClass}">
                                <span class="state__icon icon ${icon}"></span>
                                <span class="state__text">${r["Estado de póliza"]}</span>
                            </div>
                        </div>
                    </div>
                </div>
...
,
  ...
  },
  {
    ...
    "Nombre del riesgo": "Mercedes-Benz Clase C",
